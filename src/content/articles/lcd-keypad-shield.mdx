...
![LCD keypad shield schematic](@img/lcd-keypad-shield/schematic.png)
...
<TabBar id="printing" titles={["Code", "Result"]} client:load>
  <TabPane id="printing" index={0} client:load>
    <CodeFile src="code/LCDShieldText.ino" />
  </TabPane>
  <TabPane id="printing" index={1} client:load>
...
<TabBar id="backlight" titles={["Code", "Result"]} client:load>
  <TabPane id="backlight" index={0} client:load>
    <CodeFile src="code/LCDShieldBacklight.ino" />
  </TabPane>
  <TabPane id="backlight" index={1} client:load>
    <VideoPlayer src="lcd-keypad-shield/backlight.mp4" />
  </TabPane>
</TabBar>
...
<TabBar id="buttons" titles={["Code", "Result"]} client:load>
  <TabPane id="buttons" index={0} client:load>
    <CodeFile src="code/LCDShieldButtons.ino" />
  </TabPane>
  <TabPane id="buttons" index={1} client:load>
    <VideoPlayer src="lcd-keypad-shield/buttons.mp4" />
  </TabPane>
</TabBar>
