...
<TabBar titles={["DS1302 Example Code", "DS1307 Example Code", "Serial Monitor Output"]} client:load>
  <TabPane index={0} client:load>
    <CodeFile src="downloads/DS130X/examples/DS1302/DateAndTime/PrintDateTime/PrintDateTime.ino" />
  </TabPane>
  <TabPane index={1} client:load>
    <CodeFile src="downloads/DS130X/examples/DS1307/DateAndTime/PrintDateTime/PrintDateTime.ino" />
  </TabPane>
  <TabPane index={2} client:load>
```
...
<TabBar titles={["DS1302 Example Code", "DS1307 Example Code", "Serial Monitor Output"]} client:load>
  <TabPane index={0} client:load>
    <CodeFile src="downloads/DS130X/examples/DS1302/DateAndTime/ReadData/ReadData.ino" />
  </TabPane>
  <TabPane index={1} client:load>
    <CodeFile src="downloads/DS130X/examples/DS1307/DateAndTime/ReadData/ReadData.ino" />
  </TabPane>
  <TabPane index={2} client:load>
```
Hour: 10
...
<TabBar titles={["DS1302 Example Code", "DS1307 Example Code", "Serial Monitor Output"]} client:load>
  <TabPane index={0} client:load>
    <CodeFile src="downloads/DS130X/examples/DS1302/Other/RAMReadWrite/RAMReadWrite.ino" />
  </TabPane>
  <TabPane index={1} client:load>
    <CodeFile src="downloads/DS130X/examples/DS1307/Other/RAMReadWrite/RAMReadWrite.ino" />
  </TabPane>
  <TabPane index={2} client:load>
    <CollapsiblePane title="DS1302" client:load>
```
Writing to RAM
Reading from RAM
...
```
    ...
    <CollapsiblePane title="DS1307" client:load>
```
Writing to RAM
Reading from RAM
...
| 2        | 0xC4    | Write                                         |
| ^        | 0xC5    | Read                                          |
| >        | >       | <div style="text-align:center">&vellip;</div> |
