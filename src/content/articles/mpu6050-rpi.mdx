...
![MPU6050 axes](@img/mpu6050-rpi/axes.png)
...
<TabBar id="basic" titles={["Code", "Output"]} client:load>
  <TabPane id="basic" index={0} client:load>
    <CodeFile src="code/mpu6050_basic.py" />
  </TabPane>
  <TabPane id="basic" index={1} client:load>
```
...
<TabBar id="rotation" titles={["Code", "Output"]} client:load>
  <TabPane id="rotation" index={0} client:load>
    <CodeFile src="code/mpu6050_rotation.py" />
  </TabPane>
  <TabPane id="rotation" index={1} client:load>
```
X: 19 Y: 0 Z: -5
X: 27 Y: -1 Z: -5
X: 34 Y: -4 Z: -4
