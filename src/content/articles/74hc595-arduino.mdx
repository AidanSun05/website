...
![74HC595 summary](@img/74hc595-arduino/register.png)
...
<TabBar titles={["Code", "Video"]} client:load>
  <TabPane index={0} client:load>
    <CodeFile src="code/74HC595.ino" />
  </TabPane>
  <TabPane index={1} client:load>
    <VideoPlayer src="74hc595-arduino/scanner.mp4" />
  </TabPane>
</TabBar>
