...
You will need to know your display's I2C address before running any code. See xref:i2c-scanner-arduino.adoc[this page] for an I2C scanner program.
...
This project uses my *SSD1306_I2C library.* link:/zipped/SSD1306_I2C.zip[Download the library in Zip format]
...
[source,cpp]
----
include::../res/downloads/SSD1306_I2C/examples/DrawGraphics/DrawGraphics.ino[]
----
...
[source,cpp]
----
include::../res/downloads/SSD1306_I2C/examples/DrawText/DrawText.ino[]
----
...
[source,cpp]
----
include::../res/downloads/SSD1306_I2C/examples/ControlCommands/ControlCommands.ino[]
----
...
[source,cpp]
----
include::../res/downloads/SSD1306_I2C/examples/ScrollDisplay/ScrollDisplay.ino[]
----
...
[source,cpp]
----
include::../res/downloads/SSD1306_I2C/examples/DisplayBitmap/DisplayBitmap.ino[]
----
...
A list of available commands can be found in the SSD1306 datasheet, for example, https://www.digikey.com/htmldatasheets/production/2047793/0/0/1/ssd1306.html[here].
