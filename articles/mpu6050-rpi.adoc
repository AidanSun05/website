...
:image: @img/mpu6050-rpi/thumbnail.jpg
...
image::mpu6050-rpi/axes.svg[MPU6050 axes]
...
I2C needs to be enabled on your Raspberry Pi before running this code. See xref:ads1115-rpi.adoc[ADS1115 with Raspberry Pi] for details.

This code prints the acceleration and gyro values on each of the three axes.

[source,python]
----
include::../res/code/mpu6050_basic.py[]
----
...
[source,python]
----
include::../res/code/mpu6050_rotation.py[]
----
