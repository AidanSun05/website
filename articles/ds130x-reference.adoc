...
This guide uses my *DS130X* library. link:/dl/DS130X.zip[Download the library in Zip format]
...
[source,cpp]
----
include::../res/lib/DS130X/examples/DS1302/DateAndTime/PrintDateTime/PrintDateTime.ino[]
----

.DS1307 example code
[source,cpp]
----
include::../res/lib/DS130X/examples/DS1307/DateAndTime/PrintDateTime/PrintDateTime.ino[]
----
...
[source,cpp]
----
include::../res/lib/DS130X/examples/DS1302/DateAndTime/ReadData/ReadData.ino[]
----

.DS1307 example code
[source,cpp]
----
include::../res/lib/DS130X/examples/DS1307/DateAndTime/ReadData/ReadData.ino[]
----
...
[source,cpp]
----
include::../res/lib/DS130X/examples/DS1302/Other/RAMReadWrite/RAMReadWrite.ino[]
----

.DS1307 example code
[source,cpp]
----
include::../res/lib/DS130X/examples/DS1307/Other/RAMReadWrite/RAMReadWrite.ino[]
----
